        ...
        $categories = [
            ...
            [
                ...
                "questions" => [
                    ...
                    ["v_2", "Memungut gambar/objek dan memperhatikannya dengan teliti?"],
                    ["v_3", "Senang melihat banyak objek?"],
                    ["v_4", "Sering berputar?"],
                    ["v_5", "Memakai kacamata?"],
                    ["v_6", "Kesulitan mengikuti objek yang digulirkan?"],
                    ["v_7", "Kesulitan kontak mata?"],
                    ["v_8", "Berpaling dari sisi ke sisi untuk melihat sesuatu?"],
                    ["v_9", "Menjangkau terlalu jauh ketika bermain/makan?"],
                ]
            ],
            ...
            [
                ...
                "type" => "radio3",
                "questions" => [
                    ["t_1", "Tidak mau bermain dengan barang 'kotor'?"],
                    ["t_2", "Tidak suka ketika wajah dilap?"],
                    ["t_3", "Terganggu tekstur kain tertentu?"],
                    ["t_4", "Tidak suka disentuh?"],
                    ["t_5", "Tidak suka disentuh tiba-tiba?"],
                    ["t_6", "Tidak suka dipeluk?"],
                    ["t_7", "Lebih suka menyentuh daripada disentuh?"],
                    ["t_8", "Menghindari menggunakan tangan?"],
                    ["t_9", "Membenturkan kepala dengan sengaja?"],
                    ["t_10", "Mencubit / menggigit / menyakiti?"],
                    ["t_11", "Memeriksa barang dengan mulut?"],
                    ["t_12", "Cenderung merasa sakit berlebihan?"],
                    ["t_13", "Mendorong atau membentur anak lain?"],
            ...
            [
                ...
                "type" => "radio3",
                "questions" => [
                    ["p_1", "Memegang tangan dalam posisi aneh?"],
                    ["p_2", "Memegangi tubuh dalam posisi aneh?"],
                    ["p_3", "Kemampuan baik menirukan hal-hal kecil?"],
                    ["p_4", "Melakukan gerakan cepat & mengejutkan?"],
                    ["p_5", "Kesulitan berpindah posisi?"],
                ]
            ],
            ...
            [
                ...
                "type" => "radio3",
                "questions" => [
                    ["vest_1", "Memegang tangan dalam posisi aneh?"],
                    ["vest_2", "Memegangi tubuh dalam posisi aneh?"],
                    ["vest_3", "Kemampuan meniru hal kecil?"],
                    ["vest_4", "Gerakan cepat & mengejutkan?"],
                    ["vest_5", "Kesulitan berpindah posisi?"],
                    ["vest_6", "Berayun saat duduk?"],
                    ["vest_7", "Banyak melompat?"],
                    ["vest_8", "Senang dilempar ke udara?"],
                    ["vest_9", "Keseimbangan baik?"],
                    ["vest_10", "Takut ruang sempit/tinggi?"],
                    ["vest_11", "Suka komidi putar?"],
                    ["vest_12", "Sering berputar-putar?"],
                    ["vest_13", "Mabuk kendaraan?"],
                    ["vest_14", "Senang diayun?"],
                    ["vest_15", "Tidak takut bergerak/jatuh?"],
                    ["vest_16", "Gelisah saat perjalanan panjang?"],
                ]
            ],
            ...
            [
                ...
                "type" => "yes_only",
                "questions" => [
                    ["bpr_1", "Terganggu oleh sentuhan fisik?"],
                    ["bpr_2", "Tidak suka dipotong kuku?"],
                    ["bpr_3", "Takut permainan keseimbangan?"],
                    ["bpr_4", "Berlebihan pada permainan berputar/ayun?"],
                    ["bpr_5", "Pasif di rumah?"],
                    ["bpr_6", "Sangat suka dipeluk/dibelai?"],
                    ["bpr_7", "Memasukkan jari/mainan ke mulut?"],
                    ["bpr_8", "Tidak suka tekstur makanan tertentu?"],
                    ["bpr_9", "Terganggu suara ribut?"],
                    ["bpr_10", "Sangat suka menyentuh barang?"],
                    ["bpr_11", "Terganggu tekstur tertentu?"],
                    ["bpr_12", "Punya ketidaksukaan ekstrem?"],
                ]
            ],
            ...
            [
                ...
                "questions" => [
                    ...
                    ["dls_13", "Menggunakan peralatan bermain?"],
            ...
            [
                ...
                "questions" => [
                    [
                        ...
                        [
                            "Diam", "Hiperaktif", "Kesulitan memanajemen frustasi",
                            "Impulsif", "Tergila-gila perhatian", "Menarik diri",
                            "Penasaran", "Agresif", "Pemalu",
                            "Bermasalah di rumah", "Bermasalah di sekolah",
                            "Emosional", "Ketakutan tidak biasa", "Mengamuk",
                            "Hubungan baik dg saudara", "Mudah berteman",
                            "Mengerti peraturan permainan", "Mengerti lelucon",
            ...
            [
                ...
                "questions" => [
                    ...
                    ["f_3", "Sulit duduk diam > 5 menit"],
                    ["f_4", "Tidak fokus > 20 menit"],
                    ["f_5", "Sering menghilangkan barang"],
                    ["f_6", "Mengamuk tanpa alasan"],
                    ["f_7", "Menolak mengikuti perintah"],
